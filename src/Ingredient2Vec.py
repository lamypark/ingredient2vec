...
class Ingredient2Vec:
	...
	def build_taggedDocument(self, ingredients, compounds, relations, filtering=0, random_sampling, num_sampling):
		...
		print '\nFilter %d, Sampling %d' % (filtering, num_sampling) 
...
if __name__ == '__main__':
	...
	corpus_ingredient_compounds = list(ingr2vec.build_taggedDocument(ingredients, compounds, relations, filtering=Config.FILTERING, random_sampling=Config.RANDOM_SAMPLING, number_sampling=Config.NUM_SAMPLING))
